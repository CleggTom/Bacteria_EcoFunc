...
# It assumes interaction structure in the form of symmetry arround the diagonal
...
U0  = 300.0 ; R0  = 100.0 ; a0  = 20.0/nSp; #B0
...
writedlm("results/meanfield_simulations/symmetric_matrix/temp_symmetric_sims/params.csv",params,',')
...
for T = 1:nTemp
    ...
    for sim = 1:nSim
        ...
        dir = string("results/meanfield_simulations/symmetric_matrix/temp_symmetric_sims/Temp_",string(T_vec[T]),"_sim_",string(sim),".csv")
        writedlm(dir,sol.u, ',')

        dir = string("results/meanfield_simulations/symmetric_matrix/temp_symmetric_sims/Resp_Temp_",string(T_vec[T]),"_sim_",string(sim),".csv")
        writedlm(dir,R, ',')
